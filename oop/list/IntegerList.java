 ...
 *
 * <p>- content: array de enteros donde guardaremos los elementos de la lista. - contentSize: número
 * de elementos guardados en la lista.
 *
 * <p>Comportamiento:
 *
 * <p>- IntegerList(): crea una lista vacía cuyo tamaño máximo va a estar determinado por una
 * constante de la clase (10).
 *
 * <p>- IntegerList(ele1, ..., eleN): crea una lista con los elementos ele1 ... eleN.
 *
 ...
 *
 * <p>- getContenSize(): nos devuelve el número de elementos que hay en la lista.
 *
...
public class IntegerList {
  ...
  protected int[] content; // array donde almacenamos los elementos de la lista
  protected int contentSize; // tamaño de la lista (nº de elementos almacenados)
