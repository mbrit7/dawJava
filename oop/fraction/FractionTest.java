...
public class FractionTest {
  ...
  public static void main(String[] args) {
    ...
    /** Create a new object */
    Fraction fraction1 = new Fraction(15, 2);
    ...
    System.out.print("\nTell a numerator for multiply: ");
    int numeratorToMultiply = s.nextInt();
    System.out.print("Tell a denominator for multiply: ");
    int denominatorToMultiply = s.nextInt();

    System.out.println(fraction1.multiplyWithAFraction(numeratorToMultiply, denominatorToMultiply));
